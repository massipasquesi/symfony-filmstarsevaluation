...
class User implements UserInterface, \Serializable
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\Avatar", mappedBy="user", cascade={"persist"})
     */
    private $avatar;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\AgeRange", inversedBy="users")
     * @ORM\JoinColumn(nullable=true)
    */
    private $ageRange;
     ...
     * Set avatar
     *
     * @param \OC\PlatformBundle\Entity\Image $avatar
     *
     * @return User
     */
